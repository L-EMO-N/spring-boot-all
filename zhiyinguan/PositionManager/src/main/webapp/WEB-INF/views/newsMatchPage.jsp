...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/news.css?v=1.0.1" />
</head>
...
<script type="text/javascript">
	var url = '../news/getNewsMatchData';
</script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/iscroll.js?v=1.0.9"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/main.js?v=1.0.3"></script>
