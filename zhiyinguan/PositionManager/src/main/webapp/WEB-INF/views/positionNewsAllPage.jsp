...
<title>推荐资讯</title>
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/main.css?v=1.0.0" />
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/news.css?v=1.0.4" />
</head>
<body style="height: 100%">
<input id="position_id" type="hidden" value="${position_id}">
<div id="wrapper">
	<div id="scroller">
		<div id="pullDown">
...
<script type="text/javascript">
	...
	var url = '../positionNewsAllPageData';
</script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/iscroll.js?v=1.0.9"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/main.js?v=1.0.0"></script>
