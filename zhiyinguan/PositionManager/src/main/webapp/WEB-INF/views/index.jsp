...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">职引官后台管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a href="admin/find" title="用户列表" href="javascript:void(0)">用户列表</a></li>
		</ul>
	</dd>
</dl>
		<dl id="menu-picture">
			<dt><i class="Hui-iconfont">&#xe613;</i> 题目管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a href="picture-list.html" title="题目管理">题目管理</a></li>
		</ul>
	</dd>
</dl>
		<dl id="menu-product">
...
/*个人信息*/
function myselfinfo(){
	var str="<div>管理员信息:</div>"
				+"<div align='center'><p>用户名:${user.user_name}</p>"
				+"<p>密码:${user.user_password}</p>"
				+"<p>头像:<img style='border-radius: 30%;width: 50px;height: 50px' alt='' src='images/${user.user_img }'></p></div>";
	layer.open({
		type: 1,
		area: ['300px','200px'],
		fix: false, //不固定
...
/*切换用户*/
function change(obj){
	layer.confirm('确认要切换用户吗？操作会退出当前登陆',function(index){
...
/*退出登陆*/
function exit(obj){
	layer.confirm('确认要退出登陆吗？',function(index){
		location.href="user/exit";
	});
}
